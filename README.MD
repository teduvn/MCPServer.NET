...
**Example:**
```bash
dotnet ef migrations add AddAuditLogs --project src/OrderManagement.Infrastructure --startup-project src/OrderManagement.WebAPI --output-dir Persistence/Migrations
```
